...
@command('now', 'pst', 'PST', hide=False)
...
@command('old', 'archive', hide=False)
...
@command('wrist', 'wrists', 'braces', 'hands', hide=False)
...
@whitelisted_streamtime
@command('botinfo', hide=True, hideAlways=False)
...
@whitelisted_streamtime
@command('credits', hide=True, hideAlways=False)
...
@command('buy', 'purchase', 'support', 'patreon', hide=False)
...
@command('game', 'gameinfo', hide=False)
...
@command('stream', 'about', 'info', 'what', hide=False)
...
@command('lang', 'language', 'codedin', hide=False)
...
@command('ide', 'emacs', 'editor', hide=False)
...
@command('college', 'school', hide=False)
...
@command('keyboard', 'kb', hide=False)
...
@command('totalTime','length', 'years', 'total', hide=False)
...
@command('compiler', 'cl', 'msvc', 'clang', hide=False)
...
@command('templates', hide=True, hideAlways=False)
...
@command('build', 'batch', hide=False)
...
@command('render', 'opengl', 'd3d', hide=False)
...
@command('learning', 'learnProgramming', hide=False)
...
@command("lib", "library", "api", "engine", hide=False)
...
@command("wrench", hide=True, hideAlways=False)
...
@command("partner", hide=True, hideAlways=False)
...
@command("math", hide=True, hideAlways=False)
...
@command('wheel', 'gamasutra', hide=True, hideAlways=False)
...
@command("cleancode", hide=True, hideAlways=False)
...
@command("jai", hide=True, hideAlways=False)
def jai(bot, trigger):
...
@command("unittest", "unittests", "tests", hide=True, hideAlways=False)
...
@command("compression", hide=True, hideAlways=False)
...
@command("break", "vacation", hide=True, hideAlways=True)
...
@command("port", "porting", hide=True, hideAlways=False)
...
@command("tablet", "wacom", "mouse", hide=False)
